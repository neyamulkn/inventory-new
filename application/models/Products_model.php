...
class Products_model extends CI_Model
{
   ...
   // KG product 
     ...
     public function record_productkg_count()
    {
        $this->db->order_by('id', 'DESC');
        $query = $this->db->get('productkg');
        $this->db->save_queries = false;

        return $query->num_rows();
    }

    public function fetch_productkg_data($limit, $start)
    {
        $this->db->order_by('id', 'DESC');
        $this->db->limit($limit, $start);
        $query = $this->db->get('productkg');
        ...
        public function record_labelkg_count()
    {
        $this->db->order_by('id', 'DESC');
        $query = $this->db->get('productkg');
        $this->db->save_queries = false;
    ...
    public function fetch_labelkg_data($limit, $start)
    {
        $this->db->order_by('id', 'DESC');
        $this->db->limit($limit, $start);
        $query = $this->db->get('productkg');
