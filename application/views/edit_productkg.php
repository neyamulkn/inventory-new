...
<?php
    $prodData = $this->Constant_model->getDataOneColumn('productkg', 'id', $id);
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12" style="text-align: right;">
							<form action="<?=base_url()?>productkg/deleteProduct" method="post" onsubmit="return confirm('Do you want to delete this Product?')">
	...
	<form action="<?=base_url()?>productkg/updateProduct" method="post">				
					<div class="row">
						<div class="col-md-4">
				...
				<div class="panel-body">
					...
					<div class="row" style="padding-top: 5px; padding-bottom: 5px;">
						...
						<div class="col-md-9">
							<?php
                                $invQty = 0;
                            $invQtyData = $this->Constant_model->getDataTwoColumn('inventorykg', 'product_code', $code, 'outlet_id', $outlet_id);
			...
			<a href="<?=base_url()?>productkg/productkg_list" style="text-decoration: none;">
