			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row" style="border-bottom: 1px solid #e0dede; padding-bottom: 8px;">
						<div class="col-md-12">
							<a href="<?=base_url()?>productkg/addproduct" style="text-decoration: none">
					...
					<form action="<?=base_url()?>productkg/searchProduct" method="get">
...
<?php
    ...
    $prodResult = $this->db->query("SELECT * FROM productkg WHERE created_datetime != '0000-00-00 00:00:00' $sort ");
    ...
    if ($prodRows > 0) {
		...
		<a href="<?=base_url()?>productkg/editproduct?id=<?php echo $id; ?>" style="text-decoration: none; margin-left: 10px;" title="Edit">
