		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form action="<?=base_url()?>DueAmount/searchcustomer" method="get">
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="22%">
											   Cradit Amount
										    </th>
