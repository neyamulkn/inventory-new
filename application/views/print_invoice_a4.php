<?php 
    ...
    $cust_address = $orderData[0]->customer_address;
...
<div id="wrapper">
		...
		<?php
            ...
            for ($i = 0; $i < count($orderItemData); ++$i) {
				...
				<tr>
	                ...
	                <td style="text-align:left; width:130px; padding-bottom: 10px" valign="top"><?php echo $name; ?><br />[<?php echo $pcode; ?>]<br />SL. <?php echo $serial; ?></td>
    ...
    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse;">
    	<tbody>
			...
			<tr>
				<td colspan="2" style="text-align:right; font-weight:bold; border-top:1px solid #000; padding-top:5px;"><?php echo $lang_grand_total; ?> :</td>
    		...
    		<tr>
		    	<?php  
					    ...
					    $countrow = count($get_debit_cradit) - 1 ;
					     ...
					     $totalDue =  $totalPrevDue + $grandTotal;
					     
					     $presentDue =  $paid_amt - $totalDue;
				 ?>
    		<?php if($totalPrevDue != 0){ ?>
    				...
    				<td colspan="2" style=" border-bottom:1px solid #000; padding-top:5px; text-align:right; font-weight:bold;">
                        <?php echo number_format($totalPrevDue, 2); ?>
    				</td>
        		</tr>
        		
        		<tr>
    				<td colspan="2" style="text-align:right; font-weight:bold; padding-top:5px;"><?php if( $totalDue > 0){ echo "Total Due :"; } if( $totalPrevDue < 0){ echo "Total Deposit :"; } ?></td>
    				<td colspan="2" style="border-top:1px solid #000; padding-top:5px; text-align:right; font-weight:bold;"><?php echo number_format($totalDue, 2); ?></td>
        		</tr>
    		<?php } ?>
    		
			<tr>    
				<td colspan="2" style="text-align:right; font-weight:bold; padding-top:5px;"><?php echo $lang_paid_amt; ?> :</td>
				<td colspan="2" style="padding-top:5px;  border-bottom:1px solid #000; text-align:right; font-weight:bold;">- <?php echo number_format($paid_amt, 2); ?></td>
    		</tr>
    		<?php
                if ($presentDue < 0) {
                    ?>
    		<tr>
				<td colspan="2" style="text-align:right; font-weight:bold; padding-top:5px;">Due Amount: </td>
