...
<form action="<?=base_url()?>pos/insertSale" method="post" target="_blank">	
	<div class="row">
		<div class="col-md-12">
...
<script type="text/javascript">
	$(document).on('ready', function() {
		...
		$("#pop_add_cust_submit").click(function () {
			...
			var address = document.getElementById("pop_cust_add").value;
			...
			if(fn.length == 0){
				...
				var addNewCustomer = $.ajax({
					url		: '<?=base_url()?>pos/addNewCustomer?fn='+fn+'&em='+em+'&mb='+mb+'&address='+address,
					type	: 'GET',
					cache	: false,
					data	: {
						format: 'json'
					...
					success	: function(data) {
						...
						document.getElementById("pop_cust_add").value 	= "";
				...
				var resultPrice = $.ajax({
							...
							success	: function(data) {
								...
								if(add_row_count == 1){
									...
									if(qty >= 1){
										var msgs 		= '<div class="row" id="item_row_'+add_row_count+'" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;"><div class="col-md-3 col-xs-3" style="background-color: #4d9fe4; color: #FFF;">'+name+' <br />['+pcode+']</div><div class="col-md-3 col-xs-3" style="text-align: center; font-size: 15px; color: #000;"><div class="row"><div class="col-md-2 col-xs-2" style=" padding-left:6px; padding-right:18px;padding-top:7px"><span onclick="minusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/minus_icon.png" /></span></div><div class="col-md-6 col-xs-5" style="padding-left: 0px; padding-right: 0px;"><input type="text" id="display_qty_'+add_row_count+'" class="form-control" value="1" onchange="manualQty(this.value, '+add_row_count+')" style="text-align:center;" /></div><div class="col-md-3 col-xs-3" style="padding-top:7px;"><span onclick="plusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/plus_icon.png" /></span></div></div></div><div class="col-md-2  col-xs-2" style="padding:2px"><input type="text" class="form-control"  name="serial[]"/></div><div class="col-md-3 col-xs-3"><input type="text" name="price_'+add_row_count+'"  onkeyup="price(this.value)" id="price_'+add_row_count+'" value="'+price+'" class="form-control" /></div><div class="col-md-1 col-xs-1" style="font-weight: bold;"><span onclick="deleteDiv('+add_row_count+')" style="cursor:pointer;">x</span></div></div><input type="hidden" name="pcode_'+add_row_count+'" id="pcode_'+add_row_count+'" value="'+pcode+'" /><input type="hidden" onkeyup="price(this.value)" name="price_'+add_row_count+'" id="price_'+add_row_count+'" value="'+price+'" /><input type="hidden" name="qty_'+add_row_count+'" id="qty_'+add_row_count+'" value="1" />';
										logDiv.append( msgs + "" );
									...
									if(check_existing_pcode == 0){
										...
										if(qty >= 1){
											var msgs 		= '<div class="row" id="item_row_'+add_row_count+'" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;"><div class="col-md-3 col-xs-3" style="background-color: #4d9fe4; color: #FFF;">'+name+' <br />['+pcode+']</div><div class="col-md-3 col-xs-3" style="text-align: center; font-size: 15px; color: #000;"><div class="row"><div class="col-md-3 col-xs-3" style=" padding-left:6px; padding-right:18px;padding-top:7px"><span onclick="minusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/minus_icon.png" /></span></div><div class="col-md-6 col-xs-5" style="padding-left: 0px; padding-right: 0px;"><input type="text" id="display_qty_'+add_row_count+'" class="form-control" value="1" onchange="manualQty(this.value, '+add_row_count+')" style="text-align:center;" /></div><div class="col-md-3 col-xs-3" style="padding-left:0px; padding-top:7px;"><span onclick="plusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/plus_icon.png" /></span></div></div></div><div class="col-md-3 col-xs-3"><input type="text" name="price_'+add_row_count+'"  onkeyup="price(this.value)" id="price_'+add_row_count+'" value="'+price+'" class="form-control" /></div><div class="col-md-1 col-xs-1" style="font-weight: bold;"><span onclick="deleteDiv('+add_row_count+')" style="cursor:pointer;">x</span></div></div><input type="hidden" name="pcode_'+add_row_count+'" id="pcode_'+add_row_count+'" value="'+pcode+'" /><input type="hidden" name="price_'+add_row_count+'" id="price_'+add_row_count+'" value="'+price+'" /><input type="hidden" name="qty_'+add_row_count+'" id="qty_'+add_row_count+'" value="1" />';
											logDiv.append( msgs + "" );
...
<div class="row" style="background-color: #373942; color: #FFF; font-weight: bold; padding-top: 10px; padding-bottom: 10px; margin: 0px; margin-top: 7px;">
	<div class="col-md-3 col-xs-3"><?php echo $lang_products; ?></div>
	<div class="col-md-3 col-xs-3"><?php echo $lang_qty; ?></div>
	<div class="col-md-2 col-xs-2">Serial</div>
	<div class="col-md-3 col-xs-3"><?php echo $lang_per_item; ?></div>
	<div class="col-md-1 col-xs-1" style="font-weight: bold;">X</div>
</div>
...
<div style="overflow: scroll; height: 330px; width: 100%;">
            ...
            if (count($susData) == 1) {
                ...
                for ($si = 0; $si < count($susItemData); ++$si) {
					...
					<div class="row" id="item_row_<?php echo $sus_row_count; ?>" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;">
						<div class="col-md-3" style="background-color: #4d9fe4; color: #FFF;"><?php echo $pcode_name; ?><br />[<?php echo $sus_pcode; ?>]</div>
						
						<div class="col-md-3" style="background-color: #4d9fe4; color: #FFF;">
	...
	<input type="text" name="price_<?php echo $sus_row_count; ?>" id="price_<?php echo $sus_row_count; ?>" value="<?php echo $sus_price; ?>" />	
                                    ...
                                    ?>	
										...
										<?php
                                            ...
                                            for ($ap = 0; $ap < count($allProdData); ++$ap) {
												...
												<button type="button" id="txtMessage_<?php echo $pp; ?>" value="<?php echo $pcode; ?>" style="margin-top: 10px; margin-left: 19px; border-radius: 5px; padding: 20px 10px 20px 10px; background-color: #005b8a; border: 0px; color: #FFF; font-family: Arial, Helvetica, sans-serif; font-size: 13px; width: 130px;">
												<?php
													...
													<?php
                                                        if ($image == 'no_image.jpg') {
                                                            ?>
															<img src="<?=base_url()?>assets/upload/products/xsmall/no_image.jpg" height="70px" style="padding-bottom: 5px;" /><br />
													<?php

                                                        } else {
                                                            ?>
															<img src="<?=base_url()?>assets/upload/products/xsmall/<?php echo $pcode; ?>/<?php echo $image; ?>" height="70px" style="padding-bottom: 5px;" /><br />
													<?php	
                                                        }
                                                    } ?>
													<?php
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="row" style="margin-top: 10px;">
						...
						<div class="col-md-6">
							<input type="text" name="pop_cust_add" id="pop_cust_add" class="form-control" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<select name="customer" class="form-control select2" style="width: 100%;">
								...
								<?php
                                    $getallcustomer = $this->Constant_model->getDataAll('customers', 'id', 'DESC');
                                    for ($p = 0; $p < count($getallcustomer); ++$p) {
                                        $get_cust_id = $getallcustomer[$p]->id;
                                        $get_cust_name = $getallcustomer[$p]->fullname; ?>
										<option value="<?php echo $get_cust_id; ?>">
											<?php echo $get_cust_name; ?>
										</option>
								<?php
                                        unset($get_cust_id);
                                        unset($get_cust_name);
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					<div class="row">
						...
						<div class="col-md-6">
                        <select name="customer" required class="select2 form-control" style="width: 100%;">
									<option value="">Select Customer Name</option>
							<?php
                                    $getallcustomer = $this->Constant_model->getDataAll('customers', 'id', 'DESC');
                                    for ($p = 0; $p < count($getallcustomer); ++$p) {
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px; display:none">
						<div class="col-md-6"><b>Product serial code :</b></div>
						<div class="col-md-6">
							<input type="hidden" name="serial_code" id="serial_code" class="form-control" placeholder=" Product serial code"/>
						</div>
					</div>
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						<div class="col-md-6"><b>Pay Cash</b></div>
						<div class="col-md-6">
							<input type="number" name="fromcash" id="fromcash" class="form-control" placeholder="Enter amount" style="border: 1px solid #3a3a3a; color: #010101;" onchange="calculatePaidAmt(this.value)" />
						</div>
					</div>
...
<script type="text/javascript">	
	...
	function checkChequePayment(ele){
	    ...
	    if(ele != 0){
			document.getElementById("selectpaymethod").style.display = "block";
		}else{
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						...
						<div class="col-md-6">
							<select name="paid_by" id="paid_by" class="form-control" style="border: 1px solid #3a3a3a; color: #010101;" onchange="checkChequePayment(this.value)">
							    <option value=1>Select Pay Method</option>
							<?php
        ...
        $("#card_numb").on("keyup", function(event) {
	        ...
	        if(card_numb.length == 0) {
				...
				document.getElementById("submit_btn").style.display = "block";
					...
					<div class="row" id="selectpaymethod" style="padding-top: 10px; padding-bottom : 10px; display:none">
						<div class="col-md-6"><b><?php echo $lang_paid_amt; ?> :</b></div>
						<div class="col-md-6">
							<input type="number" name="paid" id="paid" class="form-control" placeholder="0.00" style="border: 1px solid #3a3a3a; color: #010101;" <?php if ($keyboard == '1') {
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						<div class="col-md-6"><b>Due Amount :</b></div>
						<div class="col-md-6">
				...
				<div class="modal-footer" style="margin-top: 0px;">
					<input type="submit" value="<?php echo $lang_submit; ?>" class="btn btn-primary" id="submit_btn" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right; display: block;" />
				</div>
			</div>
		</div>
	</div>
...
<script>
			...
			var resultPrice = $.ajax({
					...
					success	: function(data) {
						...
						if(add_row_count == 1){
							...
							if(qty >= 1){
								var msgs 		= '<div class="row" id="item_row_'+add_row_count+'" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;"><div class="col-md-3 col-xs-3" style="background-color: #4d9fe4; color: #FFF;">'+name+' <br />['+pcode+']</div><div class="col-md-3 col-xs-3" style="text-align: center; font-size: 15px; color: #000;"><div class="row"><div class="col-md-2 col-xs-2" style=" padding-left:6px; padding-right:18px;padding-top:7px"><span onclick="minusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/minus_icon.png" /></span></div><div class="col-md-6 col-xs-5" style="padding-left: 0px; padding-right: 0px;"><input type="text" id="display_qty_'+add_row_count+'" class="form-control" value="1" onkeyup="manualQty(this.value, '+add_row_count+')" style="text-align:center;" /></div><div class="col-md-3 col-xs-3" style="padding-left:0px; padding-top:7px;"><span onclick="plusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/plus_icon.png" /></span></div></div></div><div class="col-md-2 col-xs-2" style="padding:2px"><input type="text" class="form-control"  name="serial[]"/></div><div class="col-md-3 col-xs-3"><input type="text" name="price_'+add_row_count+'"  onkeyup="price(this.value)" id="price_'+add_row_count+'" value="'+price+'" class="form-control" /></div><div class="col-md-1 col-xs-1" style="font-weight: bold;"><span onclick="deleteDiv('+add_row_count+')" style="cursor:pointer;">x</span></div></div><input type="hidden" name="pcode_'+add_row_count+'" id="pcode_'+add_row_count+'" value="'+pcode+'" /><input type="hidden" onkeyup="price(this.value)" name="price_'+add_row_count+'" id="price_'+add_row_count+'" value="'+price+'" /><input type="hidden" name="qty_'+add_row_count+'" id="qty_'+add_row_count+'" value="1" />';
								logDiv.append( msgs + "" );
							...
							if(check_existing_pcode == 0){
								...
								if(qty >= 1){
									var msgs 		= '<div class="row" id="item_row_'+add_row_count+'" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;"><div class="col-md-3" style="background-color: #4d9fe4; color: #FFF;">'+name+' <br />['+pcode+']</div><div class="col-md-3" style="text-align: center; font-size: 15px; color: #000;"><div class="row"><div class="col-md-2" style=" padding-left:6px; padding-right:18px;padding-top:7px"><span onclick="minusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/minus_icon.png" /></span></div><div class="col-md-6" style="padding-left: 0px; padding-right: 0px;"><input type="text" id="display_qty_'+add_row_count+'" class="form-control" value="1" onchange="manualQty(this.value, '+add_row_count+')" style="text-align:center;" /></div><div class="col-md-3" style="padding-left:0px; padding-top:7px;"><span onclick="plusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/plus_icon.png" /></span></div></div></div><div class="col-md-2 col-xs-2" style="padding:2px"><input type="text" class="form-control"  name="serial[]"/></div><div class="col-md-3 col-xs-3"><input type="text" name="price_'+add_row_count+'"  onkeyup="price(this.value)" id="price_'+add_row_count+'" value="'+price+'" class="form-control" /></div><div class="col-md-1" style="font-weight: bold;"><span onclick="deleteDiv('+add_row_count+')" style="cursor:pointer;">x</span></div></div><input type="hidden" onkeyup="price(this.value)" name="pcode_'+add_row_count+'" id="pcode_'+add_row_count+'" value="'+pcode+'" /><input type="hidden" name="price_'+add_row_count+'" id="price_'+add_row_count+'" value="'+price+'" /><input type="hidden" name="qty_'+add_row_count+'" id="qty_'+add_row_count+'" value="1" />';
									logDiv.append( msgs + "" );
						...
						// To Insert DB;
						document.getElementById("serial_code").value 		= serial_code;
						document.getElementById("final_total_payable").value 		= grandTotal;
						document.getElementById("final_total_qty").value 			= total_item_qty;
	...
	function calculatePaidAmt(ele){	
		...
		var fromcash = document.getElementById("fromcash").value;
		var fromcard = document.getElementById("paid").value;
		var summation = +fromcash+ +fromcard;
		...
		if(paid_by == "6"){
			...
			var change_amt 			= summation - payable_amt;
		}
	...
	function calculatePaidAmtGift(ele){	
		...
		var change_amt 			= 0;
		if(ele <= payable_amt){
			change_amt 			= summation - payable_amt;
		} else {
			change_amt 			= 0;
		}
	...
	function price(getpice){
			...
			tax		 				= parseFloat(tax);
						...
						//var texte = document.getElementById("price_"+p).value;
