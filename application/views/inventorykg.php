				...
				<div class="panel-body">
					...
					<div class="row" style="border-bottom: 1px solid #e0dede; padding-bottom: 8px; margin-top: -5px;">
						...
						<div class="col-md-6" style="text-align: right;">
							<a href="<?=base_url()?>inventorykg/exportInventory" style="text-decoration: none;">
					...
					<form action="<?=base_url()?>productkg/searchInventory" method="get">
							...
							<table class="table">
							    <thead>
							    	<tr>
								    	...
								    	<th width="15%">Total Stock IN KG</th>
								...
								<?php
                                    if (count($results) > 0) {
                                        foreach ($results as $data) {
                                            ...
                                            $ckInvResult = $this->db->query("SELECT qty, outlet_id FROM inventorykg WHERE product_code = '$code' ");
                                ...
                                ?>
                                			<tr>
	                                			...
	                                			<td>
		                                			<a href="<?=base_url()?>productkg/view_detail?pcode=<?php echo $code; ?>" style="text-decoration: none;">
					...
					<?php
                        ...
                        $getAllInvResult = $this->db->query('SELECT * FROM inventorykg ');
                        ...
                        for ($g = 0; $g < count($getAllInvData); ++$g) {
                            ...
                            $each_cost = 0;
                            $getCostResult = $this->db->query("SELECT purchase_price FROM productkg WHERE code = '$each_row_code' ");
