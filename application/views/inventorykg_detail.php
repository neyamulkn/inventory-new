...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		<div class="col-md-12">
				...
				<div class="panel-body">
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						...
						<div class="col-md-9" style="font-size: 16px;">
                            ...
                            $invQtyData = $this->Constant_model->getDataTwoColumn('inventorykg', 'product_code', $pcode, 'outlet_id', $outlet_id);
			...
			<?php
                if ($user_role < 3) {
                    ?>
			<form action="<?=base_url()?>productkg/updateInventoryQty" method="post" >
				<div class="panel panel-default">
					<div class="panel-body">
	...
	<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
		...
		<div class="col-md-3" style="text-align: center; padding-top: 10px;">
			...
			<button class="btn btn-primary" onclick="return confirm('Do you want to update Inventory?')" style="padding: 8px 30px; font-size: 18px;">
			Add Stock
		</div>
		
		<div class="col-md-3" style="text-align: center; padding-top: 10px;">
			<input type="hidden" name="pcode" value="<?php echo $pcode; ?>" />
			<input type="submit" name="use_stock" value="Use Stock" class="btn btn-info"  onclick="return confirm('Do you want to use Inventory?')" style="padding: 8px 30px; font-size: 18px;">
			...
			<a href="<?=base_url()?>productkg/viewInventory" style="text-decoration: none;">
