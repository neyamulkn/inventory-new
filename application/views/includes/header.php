		...
		<ul class="nav menu">
			...
			<li <?php if ($tk_c == 'gift_card') {
				...
				<ul class="children <?php if ($tk_c != 'products') {
				    ...
				    <li>
						<a <?php if (($tk_m == 'addproduct')) {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>products/addproduct">
						Add product
						</a>
					</li>
					
					<li>
						<a <?php if (($tk_m == 'list_products' || $tk_m == 'searchProduct')) {
                    ?> style="background-color: #e9ecf2;" <?php 
			...
			<li <?php if ($tk_c == 'productkg') {
                    ?> class="parent active" <?php 
                } else {
                    echo 'class="parent"';
                } ?>>
				<a data-toggle="collapse" href="#sub-item-productkg">
					Stock In KG
				</a>
				<ul class="children <?php if ($tk_c != 'productkg') {
                    ?> collapse <?php 
                } ?>" id="sub-item-productkg">
				    
				    <li>
						<a <?php if (($tk_m == 'addproduct')) {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>productkg/addproduct">
						Add product
						</a>
					</li>
					
					<li>
						<a <?php if (($tk_m == 'productkg_list' || $tk_m == 'searchProduct')) {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>productkg/productkg_list">
							<?php echo $lang_list_products; ?>
						</a>
					</li>
					...
					<li>
						<a <?php if (($tk_m == 'viewInventory' || $tk_m == 'view_detail')) {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>productkg/viewInventory">
							View Inventory
						</a>
					</li>
	        ...
	        <li <?php if ($tk_c == 'pos') {
				...
				<a href="<?=base_url()?>pos">Sale Products</a>
			</li>
			
			
			<li <?php if ($tk_c == 'DueAmount') {
                ?> class="active" <?php 
            } ?>>
				<a href="<?=base_url()?>DueAmount/view">PayMent Details</a>
			</li>
